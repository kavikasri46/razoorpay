...
const passwords = [
  '', 'admin', 'admin123', 'password', 'root', 'root123', 'postgres', 'Arun', 'arun', 'Lacerpay', 'laserpay', 'postgres123',
...
async function testPasswords() {
  for (const pw of passwords) {
    ...
    const url = pw 
      ? `postgresql://postgres:${pw}@localhost:5432/laserpay?schema=public`
      : `postgresql://postgres@localhost:5432/laserpay?schema=public`;
